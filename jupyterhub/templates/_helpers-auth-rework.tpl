...
custos: custosauthenticator.CustosOAuthenticator
{{- end }}
...
custos.client_id: CustosOAuthenticator.client_id
custos.client_secret: CustosOAuthenticator.client_secret
custos.custos_host: CustosOAuthenticator.custos_host
custos.oauth_callback_url: CustosOAuthenticator.oauth_callback_url
{{- end }}
